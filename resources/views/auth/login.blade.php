       ...
       <div class="userbtns">
           ...
           <div class="userccount whitebg">
               ...
               <div class="tab-content">
                   <div id="candidate" class="formpanel mt-0 tab-pane {{($c_or_e == 'candidate')? 'active':''}}">
                     ...
                     <!--  <div class="socialLogin">
                                   ...
                                   <a href="{{ url('login/jobseeker/facebook')}}" class="fb"><i class="fab fa-facebook" aria-hidden="true"></i></a><!<a href="{{ url('login/jobseeker/twitter')}}" class="tw"><i class="fab fa-google" aria-hidden="true"></i></a> </div>-->
               ...
               <!-- sign up form end-->
                   ...
                   <!--    <div class="socialLogin">
                                   <h5>{{__('Login with Social')}}</h5>
                                   <a href="{{ url('login/employer/facebook')}}" class="fb"><i class="fab fa-facebook" aria-hidden="true"></i></a> <a href="{{ url('login/employer/twitter')}}" class="tw"><i class="fab fa-google" aria-hidden="true"></i></a> </div>-->
